...
export class PassInstance implements IPass {
    ...
    private _bindingLayout: GFXBindingLayout;
    private _pipelineLayout: GFXPipelineLayout;
    private _pipelineState: GFXPipelineState;
    ...
    public getHandle (name: string, offset?: number, targetType?: GFXType): number {
    ...
    public createPipelineState (defineOverrides?: IDefineMap, stateOverrides?: IPassStates): GFXPipelineState {
